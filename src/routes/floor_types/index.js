...
import getDeleteCountryGQL from "../../gql/mutations/delete_floor_types.graphql";
...
class App extends React.Component {
    ...
    updateData = async () => {
        try {
            ...
            this.setData(cache.getFloorTypes.data.floor_types)
        } catch (err) { }
    }
    ...
    handleRowDelete = async (oldData, resolve, reject) => {
        ...
        cache.getFloorTypes.data.floor_types = cache.getFloorTypes.data.floor_types.filter(x => x.id != oldData.id)
